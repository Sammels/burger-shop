...
def view_orders(request):
    orders = OrderSerializer(Order.objects.orders_with_total_cost_and_prefetched_products().filter(status='new'), many=True)
    current_url = request.path
    print(current_url)
    return render(
        request, template_name="order_items.html", context={"order_items": orders.data,
